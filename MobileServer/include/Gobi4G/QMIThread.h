...
#define IpFamilyV6 (0x06)
    ...
    typedef struct PROFILE_AND_FD
    {
        char *qmichannel;
        int socket_fd;
    } PROFILE_AND_FD_T, *PROFILE_AND_FD_PTR;
...
#define RIL_UNSOL_DATA_CALL_LIST_CHANGED 0x1005
    ...
    extern int QmiThreadRecvQMI(void *arg, PQCQMIMSG pResponse);
    ...
    extern void qmidevice_send_event_to_main(int fd, int triger_event);
    ...
    extern int requestRegistrationState(UCHAR *pPSAttachedState, CHAR *pDataCapStr);
